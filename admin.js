...
function renderConfig(area) {
  area.innerHTML = `
    <div class="admin-card">
      ...
      <div class="admin-card-body padded">
        <div class="form-group">
          <label>Correos de Administrador (uno por línea)</label>
          <textarea id="adminEmails" rows="4" style="width:100%;padding:12px;border:1.5px solid var(--border);border-radius:var(--radius-sm);font-family:monospace;font-size:14px;">${ADMIN_EMAILS.join('\n')}</textarea>
        </div>
        <p style="color:var(--warning);font-size:13px;margin-bottom:16px;">⚠️ Para agregar admins, modifica el array ADMIN_EMAILS en admin.js</p>
        <div class="form-group">
